#
# Module manifest for module 'ADSSQLNotebook'
#
...
RootModule = 'ADSSQLNotebook.psm1'
...
FunctionsToExport = 'New-ADSWorkBook','New-ADSWorkBookCell','Convert-ADSPowerShellForMarkdown'
